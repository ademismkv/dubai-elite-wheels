    ...
    <div className="bg-black min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="max-w-4xl">
              <h1 className="text-6xl md:text-8xl font-light text-white mb-8 tracking-wider">
                BORN IN DUBAI
                <span className="block text-4xl md:text-6xl text-white/50 font-extralight mt-4">
                  DRIVEN BY OBSESSION
                </span>
              </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-8">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8">
                <h3 className="text-2xl font-light text-white mb-4 tracking-wider">EXCLUSIVE PARTNERSHIPS</h3>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8">
                <h3 className="text-2xl font-light text-white mb-4 tracking-wider">CONCIERGE SERVICES</h3>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div 
                key={index}
                className="bg-white/5 backdrop-blur-sm border border-white/10 p-12 text-center hover:border-white/30 transition-all duration-500"
              >
                <h3 className="text-2xl font-light text-white mb-8 tracking-widest">
                  {value.title}
                </h3>
      ...
      <section className="py-32 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/60 max-w-4xl mx-auto leading-relaxed mb-16">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-16">
            <blockquote className="text-2xl font-light text-white/80 italic leading-relaxed">
